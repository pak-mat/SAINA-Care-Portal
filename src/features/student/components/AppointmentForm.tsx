...
export default function AppointmentForm({ onDone, user }: AppointmentFormProps) {
 ...
 <div className="mb-8 bg-slate-50/80 dark:bg-zinc-900/40 p-5 rounded-lg border border-slate-200/50 dark:border-zinc-800/50 shadow-sm relative z-10">
 ...
 ${category === cat ? 'bg-emerald-600 dark:bg-emerald-600 border-emerald-600 text-white shadow-md -translate-y-0.5' : 'bg-white/80 dark:bg-zinc-800/80 backdrop-blur-sm border-slate-200/60 dark:border-zinc-700/60 text-slate-600 dark:text-zinc-400 hover:border-emerald-400 dark:hover:border-emerald-500 hover:shadow-sm hover:bg-white dark:hover:bg-zinc-800'}`}
 >
 {cat}
 </button>
 ))}
 ...
 className="w-full h-36 glass-panel border-slate-200/80 dark:border-zinc-700/80 rounded-lg p-5 focus:bg-white dark:focus:bg-zinc-800 text-sm font-medium text-slate-900 dark:text-zinc-100 outline-none focus:ring-2 focus:ring-emerald-500/50 shadow-sm transition-all resize-none placeholder:text-slate-400"
 />
 ...
 className="bg-white/80 dark:bg-zinc-800/80 backdrop-blur-md border border-slate-200/60 dark:border-zinc-700/60 rounded-lg p-5 flex gap-4 shadow-sm"
 >
 <div className={`w-14 h-14 rounded-lg shrink-0 flex items-center justify-center font-black text-lg shadow-inner ${getAvatarClass(selectedCounselorProfile.avatarColor)}`}>
 ...
 className="bg-emerald-600 hover:bg-emerald-700 text-white disabled:opacity-50 disabled:cursor-not-allowed font-bold py-4 px-6 rounded-xl transition-all shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 dark:focus:ring-offset-zinc-900 w-full flex items-center justify-center gap-2 "
 >
