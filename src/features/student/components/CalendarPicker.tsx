...
export default function CalendarPicker({ selectedDate, onSelectDate, getAvailableSlots }: CalendarPickerProps) {
 ...
 return (
 <div className="bg-slate-50/80 dark:bg-zinc-900/60 backdrop-blur-md rounded-lg p-5 sm:p-6 border border-slate-200/50 dark:border-zinc-800/50 shadow-sm relative z-10">
 ...
 btnClass += "bg-emerald-600 text-white shadow-lg shadow-emerald-600/30 scale-[1.05] ";
 } else {
 btnClass += "bg-white dark:bg-zinc-800 text-emerald-700 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-900/50 shadow-sm hover:shadow-md hover:bg-emerald-50 dark:hover:bg-emerald-900/30 ";
