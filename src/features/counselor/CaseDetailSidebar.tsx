...
export default function CaseDetailSidebar({ request, onClose, user, onStartChat }) {
 ...
 <button onClick={() => submitSaveNotes()} className="text-xs font-bold bg-emerald-100/80 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 px-4 py-2 rounded-lg hover:bg-emerald-200 dark:hover:bg-emerald-800/50 transition-all shadow-sm flex items-center gap-1.5 ">
 ...
 <div className="bg-red-50/50 dark:bg-red-950/20 backdrop-blur-xl border border-red-200/60 dark:border-red-900/40 rounded-lg p-6 shadow-sm mt-8 relative overflow-hidden">
