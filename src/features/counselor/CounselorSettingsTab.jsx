...
export default function CounselorSettingsTab() {
  ...
  return (
    <motion.div initial={{opacity:0, y:10}} animate={{opacity:1, y:0}} exit={{opacity:0, y:-10}} className="max-w-6xl mx-auto pb-12 px-4 sm:px-6">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-slate-900 dark:text-zinc-100 flex items-center gap-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>
          Counselor Social Configuration
        </h2>
        <p className="text-sm text-slate-500 dark:text-zinc-400 mt-1 font-medium">Fine-tune your clinical bio, focus areas, active colors, and custom credentials.</p>
      </div>
        ...
        <div className="lg:col-span-8 xl:col-span-8 space-y-6">
          ...
          <div className="bg-white dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-2xl shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 dark:border-zinc-700/60 bg-slate-50/50 dark:bg-zinc-900/20 flex items-center gap-2">
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-100">Clinical Counselor Profile</h3>
            </div>
                  ...
                  <div className="flex flex-wrap gap-2.5">
                    {bannerPresets.map(preset => (
                      <button 
                        ...
                        className={`w-9 h-9 rounded-full ${preset.class} transition-transform flex items-center justify-center border-2 ${bannerStyle === preset.id ? 'border-blue-600 scale-110 shadow-md ring-2 ring-blue-500/20' : 'border-transparent hover:scale-105'}`}
                        title={preset.name}
                      >
          ...
          <div className="bg-white dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-2xl shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 dark:border-zinc-700/60 bg-slate-50/50 dark:bg-zinc-900/20 flex items-center gap-2">
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-100">Automated Signature Template</h3>
            </div>
          ...
          <div className="bg-white dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-xl shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 dark:border-zinc-700/60 bg-slate-50/50 dark:bg-zinc-900/20 flex items-center gap-2">
            ...
            <div className="p-5 border-t border-slate-150 dark:border-zinc-700/60 bg-slate-50 dark:bg-zinc-900/40 flex items-center justify-between">
              ...
              <button 
                type="button"
                onClick={handleSave}
                className="bg-blue-700 hover:bg-blue-800 text-white font-bold text-sm px-6 py-2.5 rounded-xl flex items-center gap-2 transition-all hover:scale-[1.01] active:scale-[0.99] shadow"
              >
