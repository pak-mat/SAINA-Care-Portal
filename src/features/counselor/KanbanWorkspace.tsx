        ...
        {columns.map(col => {
          ...
          return (
            <div key={col.title} className="w-80 min-w-[320px] flex flex-col max-h-full">
              ...
              <div className="flex-1 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-md border border-white/60 dark:border-zinc-800/50 rounded-lg p-3 overflow-y-auto shadow-[inset_0_2px_12px_rgba(0,0,0,0.02)]">
                {col.items.length === 0 ? (
