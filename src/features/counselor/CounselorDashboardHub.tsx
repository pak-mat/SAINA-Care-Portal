...
import { ChevronRight, ImagePlus, Send, X, Paperclip, FileText, Download } from 'lucide-react';
...
function CounselorChatTab({ user, defaultStudentId, requests }) {
  ...
  const handleSend = (e) => {
    ...
    sendMessage.mutate({ text: text.trim(), file: file || undefined, imagebase64: (!file && imageBase64) ? imageBase64 : undefined, senderId: user.id });
