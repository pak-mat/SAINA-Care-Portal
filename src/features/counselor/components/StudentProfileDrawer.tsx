...
export default function StudentProfileDrawer({ isOpen, onClose, student, onSave }: { isOpen: boolean, onClose: () => void, student: User | null, onSave: (data: Partial<User>) => void }) {
 ...
 <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500 opacity-20 rounded-full blur-3xl translate-x-1/2 -translate-y-1/4 pointer-events-none"></div>
 ...
 <div className="w-16 h-16 rounded-lg bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 shrink-0 text-white font-bold text-2xl shadow-xl">
