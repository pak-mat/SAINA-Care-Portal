...
export const mapUserDTO = (dbUser: any): User => ({
  ...
  bio: dbUser.bio || dbUser.preferences?.bio,
  bannerStyle: dbUser.banner_style || dbUser.bannerStyle || dbUser.preferences?.bannerStyle,
  avatarColor: dbUser.avatar_color || dbUser.avatarColor || dbUser.preferences?.avatarColor,
  avatarUrl: dbUser.avatar_url || dbUser.preferences?.avatarUrl,
  interests: dbUser.interests || dbUser.preferences?.interests,
  socialHandles: dbUser.social_handles || dbUser.socialHandles || dbUser.preferences?.socialHandles,
